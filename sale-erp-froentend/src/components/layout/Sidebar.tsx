...
const menuItems: MenuItem[] = [
  ...
  },
  {
    ...
    submenu: [
      ...
      { label: 'Batch Wise', href: '/reports/item-transaction/batch', icon: <BarChart3 size={18} />, access: rule(FEATURE_PERMISSIONS.report.itemTransactionsBatch) },
      { label: 'Serial/IMEI', href: '/reports/item-transaction/serial', icon: <BarChart3 size={18} />, access: rule(FEATURE_PERMISSIONS.report.itemTransactionsSerial) },
      { label: 'General', href: '/reports/item-transaction/general', icon: <BarChart3 size={18} />, access: rule(FEATURE_PERMISSIONS.report.itemTransactionsGeneral) },
      ...
      { label: 'Purchase Payment', href: '/reports/purchase/payment', icon: <BarChart3 size={18} />, access: rule(FEATURE_PERMISSIONS.report.purchasePayments) },
      ...
      { label: 'Sale Payment', href: '/reports/sale/payment', icon: <BarChart3 size={18} />, access: rule(FEATURE_PERMISSIONS.report.salePayments) },
      { label: 'Customer Due', href: '/reports/due/customer', icon: <BarChart3 size={18} />, access: rule(FEATURE_PERMISSIONS.report.customerDues) },
      ...
      { label: 'Expired Item Report', href: '/reports/expired-items', icon: <BarChart3 size={18} />, access: rule(FEATURE_PERMISSIONS.report.expiredItems) },
