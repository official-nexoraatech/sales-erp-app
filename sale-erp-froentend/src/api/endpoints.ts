...
export const reportsApi = {
  ...
  itemSales: (params?: any) => axiosClient.get<ApiResponse<any>, ApiResponse<any>>('/api/v1/reports/item-sales', { params }),
  itemPurchases: (params?: any) => axiosClient.get<ApiResponse<any>, ApiResponse<any>>('/api/v1/reports/item-purchases', { params }),
  ...
  itemTransactionsBatch: (params?: any) => axiosClient.get<ApiResponse<any>, ApiResponse<any>>('/api/v1/reports/item-transactions/batch', { params }),
  ...
  itemTransactionsSerial: (params?: any) => axiosClient.get<ApiResponse<any>, ApiResponse<any>>('/api/v1/reports/item-transactions/serial', { params }),
