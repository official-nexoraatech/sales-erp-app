export const PERMISSIONS = {
  ...
  STAFF_ATTENDANCE_CREATE: 'STAFF_ATTENDANCE_CREATE',
  STAFF_ATTENDANCE_UPDATE: 'STAFF_ATTENDANCE_UPDATE',
  STAFF_ATTENDANCE_VIEW: 'STAFF_ATTENDANCE_VIEW',
  STAFF_DOCUMENT_DELETE: 'STAFF_DOCUMENT_DELETE',
  STAFF_DOCUMENT_UPLOAD: 'STAFF_DOCUMENT_UPLOAD',
  STAFF_DOCUMENT_VIEW: 'STAFF_DOCUMENT_VIEW',
  ...
  STAFF_EMPLOYEE_VIEW: 'STAFF_EMPLOYEE_VIEW',
  STAFF_LEAVE_APPROVE: 'STAFF_LEAVE_APPROVE',
  STAFF_LEAVE_CANCEL: 'STAFF_LEAVE_CANCEL',
  STAFF_LEAVE_CREATE: 'STAFF_LEAVE_CREATE',
  STAFF_LEAVE_REJECT: 'STAFF_LEAVE_REJECT',
  STAFF_LEAVE_VIEW: 'STAFF_LEAVE_VIEW',
  STAFF_PAYROLL_CREATE: 'STAFF_PAYROLL_CREATE',
  STAFF_PAYROLL_UPDATE: 'STAFF_PAYROLL_UPDATE',
  STAFF_PAYROLL_VIEW: 'STAFF_PAYROLL_VIEW',
  STAFF_SETTING_CREATE: 'STAFF_SETTING_CREATE',
  STAFF_SETTING_DELETE: 'STAFF_SETTING_DELETE',
  STAFF_SETTING_UPDATE: 'STAFF_SETTING_UPDATE',
  STAFF_SETTING_VIEW: 'STAFF_SETTING_VIEW',
