...
export const FEATURE_PERMISSIONS = {
  ...
  staffAttendance: {
    view: PERMISSIONS.STAFF_ATTENDANCE_VIEW,
    create: PERMISSIONS.STAFF_ATTENDANCE_CREATE,
    update: PERMISSIONS.STAFF_ATTENDANCE_UPDATE,
  },
  staffEmployee: {
    view: PERMISSIONS.STAFF_EMPLOYEE_VIEW,
    create: PERMISSIONS.STAFF_EMPLOYEE_CREATE,
    update: PERMISSIONS.STAFF_EMPLOYEE_UPDATE,
    delete: PERMISSIONS.STAFF_EMPLOYEE_DELETE,
    documentView: PERMISSIONS.STAFF_DOCUMENT_VIEW,
    documentUpload: PERMISSIONS.STAFF_DOCUMENT_UPLOAD,
    documentDelete: PERMISSIONS.STAFF_DOCUMENT_DELETE,
  },
  staffLeave: {
    view: PERMISSIONS.STAFF_LEAVE_VIEW,
    create: PERMISSIONS.STAFF_LEAVE_CREATE,
    approve: PERMISSIONS.STAFF_LEAVE_APPROVE,
    reject: PERMISSIONS.STAFF_LEAVE_REJECT,
    cancel: PERMISSIONS.STAFF_LEAVE_CANCEL,
  },
  staffPayroll: {
    view: PERMISSIONS.STAFF_PAYROLL_VIEW,
    create: PERMISSIONS.STAFF_PAYROLL_CREATE,
    update: PERMISSIONS.STAFF_PAYROLL_UPDATE,
  },
  staffSetting: {
    view: PERMISSIONS.STAFF_SETTING_VIEW,
    create: PERMISSIONS.STAFF_SETTING_CREATE,
    update: PERMISSIONS.STAFF_SETTING_UPDATE,
    delete: PERMISSIONS.STAFF_SETTING_DELETE,
  },
  stockAdjustment: {
...
export const DEFAULT_ROUTE_RULES: Array<{ path: string; access: AccessRule }> = [
  ...
  { path: '/staff/employees', access: rule(FEATURE_PERMISSIONS.staffEmployee.view) },
  { path: '/staff/attendance', access: rule(FEATURE_PERMISSIONS.staffAttendance.view) },
