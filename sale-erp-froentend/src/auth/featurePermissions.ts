...
export const FEATURE_PERMISSIONS = {
  ...
  paymentNote: {
    view: PERMISSIONS.PAYMENT_NOTE_VIEW,
    create: PERMISSIONS.PAYMENT_NOTE_CREATE,
  },
  paymentOut: {
  ...
  report: {
    bankStatement: PERMISSIONS.REPORT_BANK_STATEMENT_VIEW,
    customerDues: PERMISSIONS.REPORT_CUSTOMER_DUES_VIEW,
    customerLedger: PERMISSIONS.REPORT_CUSTOMER_LEDGER_VIEW,
    dayBook: PERMISSIONS.REPORT_DAY_BOOK_VIEW,
    expenseItems: PERMISSIONS.REPORT_EXPENSE_ITEMS_VIEW,
    expensePayments: PERMISSIONS.REPORT_EXPENSE_PAYMENTS_VIEW,
    expiredItems: PERMISSIONS.REPORT_EXPIRED_ITEMS_VIEW,
    gst: PERMISSIONS.REPORT_GST_VIEW,
    inventoryValuation: PERMISSIONS.REPORT_INVENTORY_VALUATION_VIEW,
    itemTransactionsBatch: PERMISSIONS.REPORT_ITEM_TRANSACTIONS_BATCH_VIEW,
    itemTransactionsGeneral: PERMISSIONS.REPORT_ITEM_TRANSACTIONS_GENERAL_VIEW,
    itemTransactionsSerial: PERMISSIONS.REPORT_ITEM_TRANSACTIONS_SERIAL_VIEW,
    ...
    purchasePayments: PERMISSIONS.REPORT_PURCHASE_PAYMENTS_VIEW,
    sales: PERMISSIONS.REPORT_SALES_VIEW,
    salePayments: PERMISSIONS.REPORT_SALE_PAYMENTS_VIEW,
    stock: PERMISSIONS.REPORT_STOCK_VIEW,
    supplierDues: PERMISSIONS.REPORT_SUPPLIER_DUES_VIEW,
