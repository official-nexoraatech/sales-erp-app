...
export const CarrierCreatePage: React.FC = () => {
  ...
  const { register, handleSubmit, formState: { errors } } = useForm<CarrierFormData>({ resolver: zodResolver(carrierSchema), defaultValues: { status: 'ACTIVE' } });
