    ...
    <div className="space-y-5">
      ...
      <div className="overflow-hidden rounded-lg bg-white shadow">
        ...
        <div className="grid grid-cols-1 gap-4 p-5 md:grid-cols-3">
          ...
          <label className="text-sm text-gray-600">Transfer Code<div className="mt-1 flex"><input className={`${inputClass} rounded-r-none`} value={transfer.data?.data?.transferNo || 'ST/'} readOnly /><span className="flex h-10 items-center border-y border-gray-300 px-3">#</span><input className={`${inputClass} rounded-l-none`} value={isEdit ? id : 'New'} readOnly /></div></label>
        </div>
