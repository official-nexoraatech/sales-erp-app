...
| MH-17 | Customer preference center + guaranteed unsubscribe on every channel — CP-7 shipped the `customer_communication_preferences` schema only; API/UI/unsubscribe-link wiring deferred pending user confirmation of DPDP Act/TRAI applicability (see CP-7 completion report section 12) | FR-L1/L2 | CP-7 (schema only) |
