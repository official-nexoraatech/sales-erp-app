...
import { deliveryChallanFormSchema } from '../../schemas/sales-transactions.schema.js';
...
export default function DeliveryChallanFormPage() {
  ...
  const handleSubmit = (e: FormEvent): void => {
    e.preventDefault();
    const result = deliveryChallanFormSchema.safeParse({
  ...
  return (
    <form onSubmit={handleSubmit} noValidate>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 mb-6">
        <div data-tour-id="sales-challan-new-customer-select">
          <Select
            label="Customer"
            required
            value={customerId}
      ...
      <ERPStickyFooter>
        ...
        <Button
          type="submit"
          data-tour-id="sales-challan-new-save-button"
