...
const StockTransferReceivePage    = lazy(() => import('./pages/inventory/StockTransferReceivePage.js'));
  ...
  return (
    <Routes>
      ...
      >
        ...
        {/* Users */}
        <Route path="users"          element={<Page><PermissionRoute permission={PERMISSIONS.USER_VIEW}   element={<UsersPage />} /></Page>} />
        <Route path="users/new"      element={<Page><PermissionRoute permission={PERMISSIONS.USER_CREATE} element={<UserFormPage />} /></Page>} />
        <Route path="users/:id/edit" element={<Page><PermissionRoute permission={PERMISSIONS.USER_UPDATE} element={<UserFormPage />} /></Page>} />

        {/* Customers */}
        <Route path="customers"          element={<Page><PermissionRoute permission={PERMISSIONS.CUSTOMER_VIEW}   element={<CustomersPage />} /></Page>} />
        <Route path="customers/new"      element={<Page><PermissionRoute permission={PERMISSIONS.CUSTOMER_CREATE} element={<CustomerFormPage />} /></Page>} />
        <Route path="customers/:id"      element={<Page><PermissionRoute permission={PERMISSIONS.CUSTOMER_VIEW}   element={<CustomerViewPage />} /></Page>} />
        <Route path="customers/:id/edit" element={<Page><PermissionRoute permission={PERMISSIONS.CUSTOMER_UPDATE} element={<CustomerFormPage />} /></Page>} />
        ...
        <Route path="inventory/brands"         element={<Page><PermissionRoute permission={PERMISSIONS.BRAND_VIEW}     element={<BrandsPage />} /></Page>} />
        ...
        {/* GST */}
        <Route path="gst/config"       element={<Page><PermissionRoute permission={PERMISSIONS.GST_VIEW}           element={<GstConfigPage />} /></Page>} />
        ...
        {/* Accounting */}
        <Route path="accounting/chart-of-accounts"    element={<Page><PermissionRoute permission={PERMISSIONS.ACCOUNT_VIEW}              element={<ChartOfAccountsPage />} /></Page>} />
        ...
        <Route path="accounting/reports/balance-sheet" element={<Page><PermissionRoute permission={PERMISSIONS.BALANCE_SHEET_VIEW}       element={<BalanceSheetPage />} /></Page>} />
        <Route path="accounting/reports/cash-flow"    element={<Page><PermissionRoute permission={PERMISSIONS.CASH_FLOW_VIEW}            element={<CashFlowPage />} /></Page>} />
        ...
        {/* Sales */}
        <Route path="sales/quotations"              element={<Page><PermissionRoute permission={PERMISSIONS.INVOICE_VIEW}   element={<QuotationsPage />} /></Page>} />
        <Route path="sales/quotations/new"          element={<Page><PermissionRoute permission={PERMISSIONS.INVOICE_CREATE} element={<InvoiceFormPage />} /></Page>} />
        <Route path="sales/quotations/:id"          element={<Page><PermissionRoute permission={PERMISSIONS.INVOICE_VIEW}   element={<QuotationDetailPage />} /></Page>} />
        <Route path="sales/invoices"                element={<Page><PermissionRoute permission={PERMISSIONS.INVOICE_VIEW}   element={<InvoicesPage />} /></Page>} />
        <Route path="sales/invoices/new"            element={<Page><PermissionRoute permission={PERMISSIONS.INVOICE_CREATE} element={<InvoiceFormPage />} /></Page>} />
        ...
        <Route path="purchase/orders/new"    element={<Page><PermissionRoute permission={PERMISSIONS.PO_CREATE}            element={<PurchaseOrderFormPage />} /></Page>} />
        <Route path="purchase/grns"          element={<Page><PermissionRoute permission={PERMISSIONS.GRN_VIEW}             element={<GRNsPage />} /></Page>} />
        <Route path="purchase/grns/new"      element={<Page><PermissionRoute permission={PERMISSIONS.GRN_CREATE}           element={<GRNCreatePage />} /></Page>} />
        <Route path="purchase/payments"      element={<Page><PermissionRoute permission={PERMISSIONS.PAYMENT_OUT_VIEW}     element={<SupplierPaymentsPage />} /></Page>} />
        <Route path="purchase/returns"       element={<Page><PermissionRoute permission={PERMISSIONS.PURCHASE_RETURN_VIEW} element={<PurchaseReturnsPage />} /></Page>} />
        <Route path="purchase/expenses"      element={<Page><PermissionRoute permission={PERMISSIONS.EXPENSE_VIEW}         element={<ExpensesPage />} /></Page>} />

        {/* Inventory — Stock */}
        <Route path="inventory/stock"                          element={<Page><PermissionRoute permission={PERMISSIONS.ITEM_VIEW}        element={<StockLevelsPage />} /></Page>} />
        <Route path="inventory/transfers"                      element={<Page><PermissionRoute permission={PERMISSIONS.WAREHOUSE_MANAGE} element={<StockTransfersPage />} /></Page>} />
        <Route path="inventory/transfers/new"                  element={<Page><PermissionRoute permission={PERMISSIONS.WAREHOUSE_MANAGE} element={<StockTransferFormPage />} /></Page>} />
        <Route path="inventory/transfers/:id"                  element={<Page><PermissionRoute permission={PERMISSIONS.WAREHOUSE_MANAGE} element={<StockTransferDetailPage />} /></Page>} />
        <Route path="inventory/transfers/:id/receive"          element={<Page><PermissionRoute permission={PERMISSIONS.WAREHOUSE_MANAGE} element={<StockTransferReceivePage />} /></Page>} />
        <Route path="inventory/adjustments"                    element={<Page><PermissionRoute permission={PERMISSIONS.WAREHOUSE_MANAGE} element={<StockAdjustmentsPage />} /></Page>} />
        <Route path="inventory/adjustments/new"                element={<Page><PermissionRoute permission={PERMISSIONS.WAREHOUSE_MANAGE} element={<StockAdjustmentFormPage />} /></Page>} />
        ...
        <Route path="crm/campaigns"     element={<Page><PermissionRoute permission={PERMISSIONS.CRM_VIEW}           element={<CampaignsPage />} /></Page>} />
        <Route path="crm/campaigns/new" element={<Page><PermissionRoute permission={PERMISSIONS.CRM_CAMPAIGN_CREATE} element={<CampaignFormPage />} /></Page>} />
        <Route path="crm/seasons"       element={<Page><PermissionRoute permission={PERMISSIONS.CRM_SEASON_VIEW}    element={<SeasonsPage />} /></Page>} />

        {/* Production — Phase 10 */}
        <Route path="production/job-work"              element={<Page><PermissionRoute permission={PERMISSIONS.JOB_WORK_VIEW}   element={<JobWorkOrdersPage />} /></Page>} />
        <Route path="production/job-work/new"          element={<Page><PermissionRoute permission={PERMISSIONS.JOB_WORK_CREATE} element={<JobWorkOrderCreatePage />} /></Page>} />
        <Route path="production/job-work/:id/qc"       element={<Page><PermissionRoute permission={PERMISSIONS.JOB_WORK_QUALITY_CHECK} element={<JobWorkQualityCheckPage />} /></Page>} />
        ...
        <Route path="hr/employees/new"      element={<Page><PermissionRoute permission={PERMISSIONS.EMPLOYEE_CREATE} element={<EmployeeFormPage />} /></Page>} />
        <Route path="hr/employees/:id"      element={<Page><PermissionRoute permission={PERMISSIONS.EMPLOYEE_VIEW}   element={<EmployeeViewPage />} /></Page>} />
        <Route path="hr/employees/:id/edit" element={<Page><PermissionRoute permission={PERMISSIONS.EMPLOYEE_UPDATE} element={<EmployeeFormPage />} /></Page>} />
        <Route path="hr/attendance"         element={<Page><PermissionRoute permission={PERMISSIONS.ATTENDANCE_VIEW} element={<AttendancePage />} /></Page>} />
        <Route path="hr/leaves"             element={<Page><PermissionRoute permission={PERMISSIONS.LEAVE_VIEW}      element={<LeavesPage />} /></Page>} />
        ...
        <Route path="admin/distributed/dlq"         element={<Page><PermissionRoute permission={PERMISSIONS.DLQ_VIEW}                element={<DLQPage />} /></Page>} />
