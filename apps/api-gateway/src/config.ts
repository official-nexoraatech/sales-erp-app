...
const UPSTREAM_DEFAULTS: Array<{ service: string; envVar: string; default: string; apiV2: boolean }> = [
  ...
  { service: 'tenant', envVar: 'TENANT_SERVICE_URL', default: 'http://localhost:3011', apiV2: true },
  { service: 'inventory', envVar: 'INVENTORY_SERVICE_URL', default: 'http://localhost:3012', apiV2: true },
  { service: 'sales', envVar: 'SALES_SERVICE_URL', default: 'http://localhost:3013', apiV2: true },
  { service: 'notification', envVar: 'NOTIFICATION_SERVICE_URL', default: 'http://localhost:3014', apiV2: true },
  { service: 'report', envVar: 'REPORT_SERVICE_URL', default: 'http://localhost:3015', apiV2: true },
  { service: 'scheduler', envVar: 'SCHEDULER_SERVICE_URL', default: 'http://localhost:3016', apiV2: true },
  { service: 'search', envVar: 'SEARCH_SERVICE_URL', default: 'http://localhost:3017', apiV2: true },
  { service: 'gst', envVar: 'GST_SERVICE_URL', default: 'http://localhost:3018', apiV2: true },
  { service: 'accounting', envVar: 'ACCOUNTING_SERVICE_URL', default: 'http://localhost:3019', apiV2: true },
  { service: 'purchase', envVar: 'PURCHASE_SERVICE_URL', default: 'http://localhost:3020', apiV2: true },
  { service: 'hr', envVar: 'HR_SERVICE_URL', default: 'http://localhost:3021', apiV2: true },
  { service: 'production', envVar: 'PRODUCTION_SERVICE_URL', default: 'http://localhost:3022', apiV2: false },
