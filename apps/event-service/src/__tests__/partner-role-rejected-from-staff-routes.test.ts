...
// dap.routes.ts is wired via a whole-file fastify.addHook('preHandler', authenticate) call
// inside dapRoutes itself — a PARTNER-role JWT must still be rejected before it can reach any
...
describe('GET /dap/progress rejects a PARTNER-role token', () => {
